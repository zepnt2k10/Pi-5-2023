...
\begin{multicols}{2}
	...
	(Mức $B$) Cho hình vuông $ABCD$ có tâm là $O$. Gọi $E$ là trung điểm của $BC$ và  $I$ là hình chiếu vuông góc của $B$ trên $AE$. Chứng minh rằng, phân giác của góc $\angle\, IDC$ đi qua trung điểm của $OC$. 
	\begin{center}
	...
	\begin{align*}
		a=\left[x+\dfrac12\right]+\left[x\sqrt2\right].
	\end{align*}
	\begin{flushright}
