...
\begin{multicols}{2}
	...
	(Mức $B$) Tìm tất cả các số nguyên dương $x,y$, thoả mãn hệ điều kiện sau:
	\begin{align*}
		\begin{cases}
			x<y&\\
			x+2y<28&\\ 
	...
	(Mức $B$) Cho hình vuông $ABCD$ có tâm là $O$. Gọi $E$ là trung điểm của $BC$ và  $I$ là hình chiếu vuông góc của $B$ trên $AE$. Chứng minh rằng, phân giác của góc $\widehat{IDC}$ đi qua trung điểm của $OC$. 
	\begin{center}
	...
	\end{center}
	\begin{flushright}
		\textit{\small Bằng Linh, Phú Thọ (st)}
	\end{flushright}
	...
	\end{align*}
	\begin{flushright}
		\textit{\small Hoàng Ngọc Minh, Hà Nội}
	\end{flushright}
	{\color{thachthuctoanhoc}{\usefont{T5}{qag}{b}{n} P707.}}
	(Mức $A$) Chứng minh rằng ánh xạ $f:\mathbb R\to\mathbb Z$ cho bởi công thức $f(x)=\left[x+\dfrac12\right]+\left[x\sqrt2\right]$ là một toàn ánh.
	\begin{flushright}
		\textit{\small Trần Nam Dũng, Tp. Hồ Chí Minh}
	\end{flushright}
	...
	\end{align*}
	\begin{flushright}
		\textit{\small Nguyễn Tuấn Anh, Đồng Tháp}
	\end{flushright}
	...
	\end{figure}
	\begin{flushright}
		\textit{\small Lê Hoài Bắc, Bà Rịa--Vũng Tàu (st)}
	\end{flushright}
	{\color{thachthuctoanhoc}{\usefont{T5}{qag}{b}{n} P710.}}
	(Mức $A$) Cho $a$ là số nguyên dương không vượt quá $7$. Chứng minh rằng, tồn tại số nguyên $b$ sao cho với mọi số tự nhiên $n$:
	\begin{align*}
